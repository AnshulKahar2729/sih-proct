    ...
    <div className="w-full h-full" style={{backgroundColor:"#ffff" ,padding:"2% 2.5%"}}>
      ...
      <div className="w-full flex gap-5 items-center justify-center">
        <div className="flex gap-4">
            <div className="bg-blue-800 transition-all w-1/3 flex flex-col p-8 rounded-2xl text-center text-white hover:shadow-black hover:shadow-md hover:bg-white hover:text-black" >
            ...
            <div className="bg-blue-800 w-1/3 flex flex-col p-8 rounded-2xl text-center text-white hover:shadow-black hover:shadow-md hover:bg-white hover:text-black" >
